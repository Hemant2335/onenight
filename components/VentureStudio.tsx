  ...
  return (
    <section className="bg-gray-50/50 pt-16 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-stretch">
        {/* === Left Column === */}
        <div className="flex flex-col items-center bg-[#f4f4f4] p-6 md:p-2 lg:p-10 rounded-xl justify-between space-y-8 h-full">
          {/* Logo */}
          <div className="w-48">
            {/* IMPORTANT: 
        ...
        {/* === Right Column === */}
        <div className="flex flex-col space-y-6 bg-[#f4f4f4] p-6 md:p-4 lg:p-10 rounded-lg h-full">
          {/* Category Tabs */}
